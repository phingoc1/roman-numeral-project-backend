    ...
    <div class="osg-header__content">
            ...
            <div class="osg-grid osg-full-height">
                <div class="osg-grid__column--12">
                    <div class="osg-full-height osg-flex osg-flex-justify-content-flex-end osg-flex-align-items-center" >
                        <a class="osg-button osg-none-breakpoint-medium">
        ...
        <div class="osg-none osg-block-breakpoint-medium osg-full-height">
            <div class="osg-grid osg-grid--gap osg-full-height">
                <div class="osg-grid__column--12">
                    <div class="osg-full-height osg-flex osg-flex-justify-content-flex-end osg-flex-align-items-center">
                        <a href="{{ route('easy') }}" class="osg-button osg-button--outline osg-margin-right-4-breakpoint-medium osg-margin-right-8-breakpoint-large">Easy<span class="osg-button__icon osg-button__icon--right osg-icon--fire-emblem"></span></a>
                        <a href="{{ route('advanced') }}" class="osg-button osg-button--outline">Advanced<span class="osg-button__icon osg-button__icon--right osg-icon--crane"></span></a>
                    </div>
                </div>
            </div>
        </div>
